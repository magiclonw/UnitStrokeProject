...
public class DashBoardView extends View {
    ...
    private String mHeaderText = "元"; // 表头
    ...
    protected void onDraw(Canvas canvas) {
         ...
         */
        canvas.save();
        mPaint.setStrokeWidth(mStrokeWidth / 3f);
...
//  源码这个不知何用去了不影响结果          mPaint.getTextBounds(mHeaderText, 0, mTexts[i].length(), mRectText);
         ...
         * 画实时度数值
         */
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.color_blue));
    ...
    public void setHeaderTest(String headerTest){
        this.mHeaderText=headerTest;
//        postInvalidate();
    }
}
